...
import { params } from './assets/3202/params';
...
const select = document.querySelector.bind(document),
      ...
      CAMPAIGN = 'mindshare-ski-doo-3202',
      PROJECTNUMBER = 'mndshrescters',
      CLICKURL = 'https://ad.doubleclick.net/ddm/trackclk/N333003.1922736AMEDIA.NO/B21832408.231768174;dc_trk_aid=429409864;dc_trk_cid=107446688;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=';

      //fakeSf(banner);

      let loopCount = 0,
          endedListenerAdded = false,
          inViewPossible = getSafeFrameInViewUpdates(320, 400, inViewListener, 25),
      ...
      function streaming() {
        ...
        playerUtils.queueCue(11.8, 14.9, 'hidden', (ev, txt)=>{
      ...
      function impression() {
        track('impression');
        addPxl(`https://ad.doubleclick.net/ddm/trackimpj/N333003.1922736AMEDIA.NO/B21832408.231768174;dc_trk_aid=429409864;dc_trk_cid=107446688;ord=${Date.now()};dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?`)
      }
