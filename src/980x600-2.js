...
import { params } from './assets/9802/params';
...
const select = document.querySelector.bind(document),
      ...
      CAMPAIGN = 'mindshare-ski-doo-9802',
      PROJECTNUMBER = 'mndshrescters',
      CLICKURL = 'https://ad.doubleclick.net/ddm/trackclk/N333003.1922736AMEDIA.NO/B21832408.231476720;dc_trk_aid=429295005;dc_trk_cid=107365192;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=';
      ...
      function streaming() {
        ...
        playerUtils.queueCue(11.8, 15.5, 'hidden', (ev, txt)=>{
      ...
      function impression() {
        track('impression');
        addPxl(`https://ad.doubleclick.net/ddm/trackimpj/N333003.1922736AMEDIA.NO/B21832408.231476720;dc_trk_aid=429295005;dc_trk_cid=107365192;ord=${Date.now()};dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=?`)
      }
...
import { params } from './assets/980x600-2-ski-doo/params';
...
const select = document.querySelector.bind(document),
      ...
      StreamedByFaster(params, videoElem)

      playerUtils.onClickOn(soundBtn).toggleSound.andToggleClass('on')
      playerUtils.queueCue(11.8, 15.5, 'hidden', (ev, txt)=>{
        ev === 'enter' ? logo.classList.add(txt) : logo.classList.remove(txt);
        if(ev === 'exit') {
          loopCount++;
